 ...
 */
@Data
public class BaseSqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    public BaseSqlSessionFactoryBean() {
    }
